...
@NamedQueries({
    ...
    , @NamedQuery(name = "Trainers.findByVat", query = "SELECT t FROM Trainers t WHERE t.vat = :vat")
    , @NamedQuery(name = "Trainers.findByUsername", query = "SELECT t FROM Trainers t WHERE t.username = :username")
    , @NamedQuery(name = "Trainers.findByPasswordLog", query = "SELECT t FROM Trainers t WHERE t.passwordLog = :passwordLog")
...
public class Trainers implements Serializable {
    ...
    public Trainers(Integer vat) {
        this.vat = vat;
    }

    public Trainers(Integer vat, String username, String passwordLog, String firstName, String lastName) {
        this.vat = vat;
    ...
    public String toString() {
        return "com.example.bootcamp.entities.Trainers[ vat=" + vat + " ]";
    }
